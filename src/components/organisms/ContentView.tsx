  ...
  return (
    <main className="flex-1 relative pointer-events-none" id="garden-canvas">
      ...
      <div className="absolute inset-0 opacity-20 filter blur-sm">
        ...
        <div className="absolute top-[25%] left-[80%] size-16 bg-surface-dark rounded-full border border-slate-700"></div>
        <div className="absolute top-[30%] left-[20%] size-12 bg-surface-dark rounded-full border border-slate-700"></div>
        <div className="absolute top-[75%] left-[25%] size-10 bg-surface-dark rounded-full border border-slate-700"></div>
      </div>

      {/* Central Window */}
      <div className={cn("z-50 flex w-full  items-center justify-center p-4 md:p-8 pointer-events-auto", className)}>
        <div className="w-full max-w-6xl md:max-h-[75vh]  glass-panel rounded-xl flex flex-col overflow-auto shadow-[0_0_50px_rgba(0,0,0,0.6)] animate-[fadeIn_0.5s_ease-out] border border-slate-700/50 relative">
          {/* Scanline Overlay */}
